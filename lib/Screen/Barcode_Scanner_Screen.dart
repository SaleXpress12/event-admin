              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(50.0)),color: accentColor),
                      ...
                      Container(
                          decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(30.0)),color: accentColor),
                        margin: const EdgeInsets.all(8),
                        child: InkWell(
                            onTap: () async {
