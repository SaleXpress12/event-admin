...
class UpdateEventDetailScreen extends StatefulWidget {
  ...
  @override
  State<UpdateEventDetailScreen> createState() =>
      _UpdateEventDetailScreenState();
}
...
class _UpdateEventDetailScreenState extends State<UpdateEventDetailScreen> {
  ...
  void onMapCreated(GoogleMapController controller) {
    ...
    Geolocator.getCurrentPosition().then((value) {
      setState(() {
        currentPosition = const LatLng(40.730610, -73.935242);
  ...
  Future uploadPicture() async {
    Reference storageReference =
        FirebaseStorage.instance.ref().child('Pictures/${DateTime.now()}');
        ...
        imageFile == null
            ? await FirebaseFirestore.instance
                ...
                FirebaseFirestore.instance
                  ...
                  "userName": "Admin",
                  "userProfile":
                      "https://firebasestorage.googleapis.com/v0/b/evente-pro.appspot.com/o/5546667.png?alt=media&token=d27e22fa-8461-4755-b54a-f00b9dd3abd2"
                });
              }).then((value) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
            ...
            Expanded(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    getVerSpace(20),
                    getCustomFont(
                        "Choose Location Address", 16, Colors.black, 1,
                        fontWeight: FontWeight.w600, txtHeight: 1.5),
                    getVerSpace(10),
                    Stack(
                      children: [
                        SizedBox(
                          ...
                          child: GoogleMap(
                            ...
                            initialCameraPosition: CameraPosition(
                              ...
                              target: LatLng(
                                  widget.event?.mapsLatLink ?? 40.730610,
                                  widget.event?.mapsLangLink ?? -73.935242),
                              zoom: 10,
                            ),
                    ...
                    loading == true
                        ...
                        : getButton(
                            ...
                            //           children: [
                            //             getVerSpace(40 ),
                            //            const Icon(Icons.error,size: 120.0,color: Colors.red,),
                            //
                            //        ],
                            //         ),
                            //       ),
