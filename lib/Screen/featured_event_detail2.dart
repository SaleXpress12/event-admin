    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          getCustomFont("\$${event.price}" ?? "", 20, Colors.black, 1,
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(PageRouteBuilder(
                          pageBuilder: (_, __, ___) => BarcodeScannerScreen(
                  ...
                  return snapshot.hasData
                      ? InkWell(
                          onTap: () {
                            ...
                            //                       "This Feature Ready on Release APK.",
                            //                       16,
                            //                       Colors.black,
                            //                       fontWeight: FontWeight.w500,
                            //                       txtHeight: 1.5),
...
class joinEvents extends StatelessWidget {
  const joinEvents({super.key, this.list});
