...
AppBar getToolBar(Function function, {Widget? title, bool leading = true}) {
  return AppBar(
    ...
    leading: leading == true
        ? getPaddingWidget(
            const EdgeInsets.only(top: 26  , bottom: 23  ),
            GestureDetector(
                onTap: () {
                  function();
                },
                child:
                   const Icon(Icons.arrow_back_ios_rounded,size: 24.0,color: Colors.black,)))
        : null,
  );
}
...
Widget settingContainer(Function function, String title, String image) {
  return GestureDetector(
    ...
    child: Container(
      ...
      padding: const EdgeInsets.only(bottom: 3  , left: 3  , top: 3  , right: 18  ),
      child: Row(
